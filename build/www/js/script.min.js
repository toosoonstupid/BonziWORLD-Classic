...
function errorFatal() {
    "none" == $("#page_ban").css("display") && $("#page_error").show();
}
function setup() {
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "green", "pm", "merlin", "peedy", "robby", "genie", "purple", "red", "pink", "pope", "popehat", "hammer", "notpope", "walter", "einstein", "luther", "danieltard69", "danieltard692"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "topjej"];
